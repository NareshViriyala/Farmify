...
public class DialogAddKeyValueSocialItem extends Dialog implements View.OnClickListener{
    ...
    public void validateAssetDialog(){
        try{
            ...
            JSONArray assetList;
            if(fragmentSocial.farmersocialData.has(jsonKey))
                assetList = fragmentSocial.farmersocialData.getJSONArray(jsonKey);
            else
            ...
            fragmentSocial.farmersocialData.put(jsonKey, assetList);
